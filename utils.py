...
def upload_image(image, file_name):
    ...
    s3_client.put_object(Body=image_string, Bucket=bucket_name,
                         Key=full_file_name, ContentType='image/jpeg')
    # Generate URL for image
    file_url = 'https://api.selfie2anime.com/analysis/me?uuid={}'.format(
        file_name[:-4])
    return file_url
